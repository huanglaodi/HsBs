...
/// add Palm by pyc
/// 2018-10-12
public class FKDataHS103_UserIdInfo {
    ...
    public static final int STRUCT_SIZE = 36;        // sizeof(USER_ID_CIF13)
    ...
    public FKDataHS103_UserIdInfo(byte[] abytUserIdInfo) {
        ...
        flagEnrolled = MyUtil.byte2int(Arrays.copyOfRange(abytUserIdInfo, 34, 36));
    ...
    public byte[] GetBackupNumberEnrolledFlag() {
        byte[] abytEnrolledFlag = new byte[STRUCT_SIZE];
    ...
    public byte[] GetUserIdInfo() {
        byte[] abytUserIdInfo = new byte[STRUCT_SIZE];
